...
def createExcelMatrix(hostsql, usersql, passwordsql, dataBaseName, tableName, formatMatrixFile, formatFile):
...
if __name__ == '__main__':
    ...
    createExcelMatrix(hostsql, usersql, passwordsql, dataBaseName, tableName, formatMatrixFile, formatFile)